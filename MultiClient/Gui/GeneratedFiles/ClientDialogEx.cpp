...
static const uint qt_meta_data_Cry__ClientDialog[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Bool, 0x80000000 | 3, 0x80000000 | 8,    7,    9,
...
void Cry::ClientDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->DelegateSignInMsg((*reinterpret_cast< const u32(*)>(_a[1])),(*reinterpret_cast< const std::string(*)>(_a[2])));
        ...
        {
            typedef bool (ClientDialog::*_t)(const u32 , const std::string & );
...
// SIGNAL 1
bool Cry::ClientDialog::DelegateSignInMsg(const u32 _t1, const std::string & _t2)
{
    bool _t0{};
